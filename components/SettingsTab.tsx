...
import { Volume2, Smartphone, Download, RotateCcw } from 'lucide-react'
  ...
  return (
    <div className="w-full h-full flex flex-col bg-background overflow-y-auto">
      ...
      >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Add ScanHub to your home screen for quick access
                  </p>
                </div>
              </div>
              <Button
        ...
        <motion.div
          variants={item}
          className="bg-card/50 border border-border rounded-xl p-4 backdrop-blur-sm mt-auto"
        >
          <div className="space-y-2 text-center">
            <h3 className="font-semibold text-foreground">ScanHub</h3>
            <p className="text-xs text-muted-foreground">
              Version 1.0.0 • Universal Barcode Scanner
            </p>
            <p className="text-xs text-muted-foreground">
              Works offline with full-screen camera access
            </p>
          </div>
        </motion.div>
      </motion.div>
